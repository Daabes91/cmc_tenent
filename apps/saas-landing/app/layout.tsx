  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href={withBasePath("/favicon-96x96.png")} type="image/png" sizes="96x96" />
        <link rel="apple-touch-icon" href={withBasePath("/apple-touch-icon.png")} sizes="180x180" />
