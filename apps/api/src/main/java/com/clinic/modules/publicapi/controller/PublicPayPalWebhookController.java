...
public class PublicPayPalWebhookController {

    private static final Logger logger = LoggerFactory.getLogger(PublicPayPalWebhookController.class);
    ...
    @Autowired
    public PublicPayPalWebhookController(PayPalPaymentService paymentService, PayPalService payPalService, ObjectMapper objectMapper) {
