 ...
 * Tests all CRUD operations with authentication, validation, and error handling.
 */
@SpringBootTest
...
public class TenantCrudApiTest {
    ...
    void shouldCreateTenantWithValidToken() throws Exception {
        ...
        mockMvc.perform(post("/saas/tenants")
                ...
                .andExpect(jsonPath("$.adminCredentials.email").value("admin@api-test-clinic.clinic.local"))
    ...
    void shouldReturn401WhenUpdatingTenantWithoutAuthentication() throws Exception {
        // Given
        TenantUpdateRequest request = new TenantUpdateRequest("New Name", null);
    ...
    void shouldReturn400WhenUpdatingWithInvalidCustomDomain() throws Exception {
        ...
        TenantUpdateRequest request = new TenantUpdateRequest(null, "invalid domain format");
