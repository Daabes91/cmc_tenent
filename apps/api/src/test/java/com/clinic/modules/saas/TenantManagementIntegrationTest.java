 ...
 * Tests complete tenant creation flow including admin staff and permissions creation,
...
public class TenantManagementIntegrationTest {
    ...
    void shouldListTenantsWithPaginationExcludingDeleted() {
        ...
        TenantResponse toDelete = tenantManagementService.listTenants(PageRequest.of(0, 10), false)
                .content().get(0);
        tenantManagementService.softDeleteTenant(toDelete.id());

        // When - List tenants without includeDeleted
        Pageable pageable = PageRequest.of(0, 3);
        TenantListResponse response = tenantManagementService.listTenants(pageable, false);
        ...
        // Should have 4 active tenants (5 created - 1 deleted) + default tenant = 5 total
    ...
    void shouldListTenantsIncludingDeletedWhenRequested() {
        ...
        TenantListResponse response = tenantManagementService.listTenants(PageRequest.of(0, 10), true);
    ...
    void shouldThrowNotFoundExceptionWhenUpdatingDeletedTenant() {
        ...
        TenantUpdateRequest updateRequest = new TenantUpdateRequest("New Name", null);
    ...
    void shouldAllowReusingSoftDeletedSlug() {
        ...
        // but if the soft-deleted tenant is not found, the database constraint will fail
        assertThatThrownBy(() -> tenantManagementService.createTenant(request2))
                .satisfiesAnyOf(
